...
def main():
    ...
    #initial_pose.pose.position.x = -0.10
    #initial_pose.pose.position.y = 0.07
    #initial_pose.pose.orientation.z = 0.04
    ...
    goal_pose1.pose.position.y = 0.09
    goal_pose1.pose.orientation.w = 0.04
    ...
    #goal_pose2.pose.position.y = -1.75
    ...
    #goal_pose3.pose.position.x = -2.6
    #goal_pose3.pose.position.y = -2.75
